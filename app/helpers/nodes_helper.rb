module NodesHelper
  def self.required_fields
    %i(
      ...
      keyUseCount keyUseLimit addinCards addinCards isAddOnCard isAgentless portInfo portType portNumber logicalPorts
      addresses vnicMode posID productName slotName slotNumber slotSupportsHotPlug arch backedBy bladeState bootMode
      ...
      powerSupplies primary processorSlots processors productID productName raidSettings secureBootMode serialNumber slots status subSlots
      subType thinkServerFru tlsVersion type uri userDescription uuid vnicMode vpdID
    )
  end
end
