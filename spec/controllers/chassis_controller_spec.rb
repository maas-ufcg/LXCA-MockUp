...
RSpec.describe ChassisController, type: :controller do
  ...
  # Chassi. As you add validations to Chassi, be sure to
  ...
  # ChassisController. Be sure to keep this updated too.
  let(:valid_session) { {} }

  describe "GET #index" do
    it "assigns all chasses as @chasses" do
      chassi = Chassi.create! valid_attributes
      get :index, params: {}, session: valid_session
      expect(assigns(:chassis)).to eq([chassi])
    end
  end
  ...
  describe "GET #show" do
    it "assigns the requested chassi as @chassi" do
      chassi = Chassi.create! valid_attributes
      get :show, params: {id: chassi.to_param}, session: valid_session
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested chassi" do
        chassi = Chassi.create! valid_attributes
        put :update, params: {id: chassi.to_param, chassi: new_attributes}, session: valid_session
        chassi.reload
      ...
      it "assigns the requested chassi as @chassi" do
        chassi = Chassi.create! valid_attributes
        put :update, params: {id: chassi.to_param, chassi: valid_attributes}, session: valid_session
        expect(assigns(:chassi)).to eq(chassi)
      end

      it "redirects to the chassi" do
        chassi = Chassi.create! valid_attributes
        put :update, params: {id: chassi.to_param, chassi: valid_attributes}, session: valid_session
        expect(response).to redirect_to(chassi)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the chassi as @chassi" do
        chassi = Chassi.create! valid_attributes
        put :update, params: {id: chassi.to_param, chassi: invalid_attributes}, session: valid_session
        expect(assigns(:chassi)).to eq(chassi)
      end
